...
\section{Semi-Inclusive Deep Inelastic Scattering (SIDIS): Basic Expressions}
...
proton is $M$ and the mass of the produced hadron is $M_B$.

\subsubsection{Lorentz Invariant Variables}
\label{eq:subsubsection}

The conventional kinematic variables are:
\begin{eqnarray}
Q^2 & = & -q^2 = -(l - l^\prime)^2 \\
\xbj & = & \frac{Q^2}{2 P \cdot q} \\
\xn & = & \frac{2 \xbj}{1 + \sqrt{1 + \frac{4 \xbj^2 Q^2}{M^2}}} \\
y & = & \frac{P \cdot q}{P \cdot l} \\
\zh & = & \frac{P \cdot \hadpsc}{P \cdot q} \\
s & = & (l + P)^2 \\
W & = & \parz{q + P}^2\, .
\end{eqnarray}
The inclusive deep inelastic limit is $Q / \Lambda_{\rm QCD} \to \infty$  with fixed $\xn$ and $\zh$.
